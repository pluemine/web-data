        ...
        <div className='row'>
            <div className='col-md-6' style={{ width: '100%', paddingTop: '10px', paddingBottom: '20px' }}>
                <div className='card' style={{ height: '100%' }}>
                    ...
                    <div className='row' style={{ width: '100%' }}>
                        <Link to={props.link1} className='button'>
                            <div onClick='window.location.reload();'>{props.button1}</div>
                        </Link>
                    </div>
                </div>
            </div>
            <div className='col-md-6' style={{ width: '100%', paddingTop: '10px', paddingBottom: '20px' }}>
                <div className='card' style={{ height: '100%' }}>
                    ...
                    <div className='row' style={{ width: '100%' }}>
                        <Link to={props.link2} className='button'>
                            <div onClick='window.location.reload();'>{props.button2}</div>
                        </Link>
                    </div>
                </div>
            </div>
