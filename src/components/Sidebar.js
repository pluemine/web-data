...
function Sidebar() {
  return (
    <div>
      <div
        className="row item"
        style={{ width: "100%", paddingTop: "60px", paddingBottom: "30px" }}
      >
      ...
      <div className="row item" style={{ width: "100%" }}>
        <a
          href="https://www.facebook.com/suchut.sapsathien.10"
          className="links"
        >
          <div className="row">
      ...
      <div className="row item" style={{ width: "100%" }}>
        <a href="profile/Resume.pdf" className="links">
          <div className="row">
            <div className="item-text">My Resume</div>
          </div>
          <div className="row">
            <div className="item-sub-text">Resume</div>
          </div>
        </a>
      </div>
      <div
        ...
        style={{ width: "100%", paddingBottom: "30px" }}
      >
        <a href="profile/Portfolio.pdf" className="links">
          <div className="row">
            <div className="item-text">My Portfolio</div>
          </div>
          <div className="row">
            <div className="item-sub-text">Portfolio</div>
          </div>
        </a>
      </div>
      <div className="row item" style={{ width: "100%" }}>
      ...
      >
        <div className="non-links">
          ...
          <div className="row">
            <div className="item-sub-text">12 May 2021</div>
          </div>
        </div>
      </div>
    </div>
